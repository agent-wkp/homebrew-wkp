...
Homebrew tap for [`wkp`](https://github.com/agent-wkp/wkp), the
...
[agent-wkp's own build-matrix notes](https://github.com/agent-wkp/wkp/blob/main/docs/plan/milestones.md)
...
from [agent-wkp's GitHub Releases](https://github.com/agent-wkp/wkp/releases),
