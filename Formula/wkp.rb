class Wkp < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/agent-wkp/wkp/releases/download/v1.0.3/wkp-aarch64-apple-darwin"
  ...
  on_linux do
    on_intel do
      url "https://github.com/agent-wkp/wkp/releases/download/v1.0.3/wkp-x86_64-unknown-linux-musl"
